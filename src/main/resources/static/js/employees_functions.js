const editButtonPress = function(button) {
	...
	let firstName = document.querySelector("#row_" + id_row
			+ " .firstNameField").innerHTML;
	let lastName = document.querySelector("#row_" + id_row + " .lastNameField").innerHTML;
	let commissionPct = document.querySelector("#row_" + id_row
			+ " .commissionPctField").innerHTML;
	...
	let managerId = document.querySelector("#row_" + id_row
			+ " .managerIdField").innerHTML;
	let hireDate = document.querySelector("#row_" + id_row + " .hireDateField").innerHTML;
	let phoneNumber = document.querySelector("#row_" + id_row
			+ " .phoneNumberField").innerHTML;
	let departmentId = document.querySelector("#row_" + id_row
			+ " .departmentIdField").innerHTML;
	let departmentName = document.querySelector("#row_" + id_row
			+ " .departmentNameField").innerHTML;
