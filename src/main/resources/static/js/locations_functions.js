const editButtonPress = function(button) {
	...
	let streetAddress = document.querySelector("#row_" + id_row
			+ " .streetAddressField").innerHTML;
	let postalCode = document.querySelector("#row_" + id_row
			+ " .postalCodeField").innerHTML;
	let city = document.querySelector("#row_" + id_row + " .cityField").innerHTML;
	let stateProvince = document.querySelector("#row_" + id_row
			+ " .stateProvinceField").innerHTML;
	let countryId = document.querySelector("#row_" + id_row
			+ " .countryIdField").innerHTML;
