const editButtonPress = function(button) {
	...
	let countryName = document.querySelector("#row_" + id_row
			+ " .countryNameField").innerHTML;
	let regionName = document.querySelector("#row_" + id_row
			+ " .regionNameField").innerHTML;
